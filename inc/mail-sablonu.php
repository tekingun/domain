...
if ($_SESSION['oturum'] == "ok" && $_SESSION['username'] != "") {
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Mail Şablonu</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title mb-5"> Mail Şablonu Düzenle</h6>
                            ...
                            <div class="email editor mt-3 mb-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="" class="col-md-2"><u>Mail Şablonu:</u></label>
                                        <textarea class="form-control" name="mail_sablon" id="simpleMdeEditor"
                                                  rows="5"><?=$sablon['mail_sablon'];?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
